...
/**
 * updatePlayer - updates the movement of the player/camera around the maze
 *
 * Return: Player
 */
void updatePlayer() 
...
/**
 * movePlayer - function that tracks movement of player in he maze
 *
 * Return
 */
...
/**
 * clipMovement
 * dx - player position on x-axis
 * dy - player position on y-axis
 *
 * Return: FALSE
 */
